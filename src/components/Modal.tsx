...
const Modal = ({ show, close, deleteBook } : ModalProps) => {
  return (
    <>
           ...
           <>
            <div className="modalOuterBox">
              <Card style={{ width: '18rem' }} className="book rounded overflow-hidden shadow-lg">
                <Card.Body>
                  <Card.Title className="font-bold text-xl mb-2">Delete Book</Card.Title>
                  <div className="book-details text-gray-700 text-base">
                    <div><span className="book-details font-semibold text-black text-base">Do you wish to delete book?</span></div>
                  </div>
